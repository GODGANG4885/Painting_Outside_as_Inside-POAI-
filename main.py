...
def load_config(mode):
    ...
    parser.add_argument('--path', '--checkpoints', type=str, default='./checkpoints/sun', help='model checkpoints path (default: ./checkpoints)')
    # parser.add_argument('--model', type=int, default=3, help='1: edge model, 2: inpaint model, 3: edge-inpaint model, 4: joint model')
    parser.add_argument('--mask_path', type=int, default=1, help='mask number')
    ...
    config_path = os.path.join(args.path, 'config/config{}.yml'.format(args.mask_path))
